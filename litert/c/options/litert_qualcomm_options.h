...
typedef enum LiteRtQualcommOptionsLogLevel {
  kQualcommLogOff = 0,
  kQualcommLogLevelError = 1,
  kQualcommLogLevelWarn = 2,
  kQualcommLogLevelInfo = 3,
  kQualcommLogLevelVerbose = 4,
  kQualcommLogLevelDebug = 5,
...
class QualcommOptions : public OpaqueOptions {
 public:
  ...
  static Expected<QualcommOptions> FromOpaque(OpaqueOptions& options);

  static QualcommOptions Create();
